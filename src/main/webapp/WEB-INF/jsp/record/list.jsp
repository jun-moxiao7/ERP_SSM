				...
				<div class="layui-card">
					<div class="layui-card-body ">
						...
						<form class="layui-form layui-col-space5" method="post"
							action="selects" id='form'>
							<table border="1">
								<caption>新建考试记录</caption>
								<tr>
									<th><label for="L_userid" class="layui-form-label">考试编号
											<span class="x-red">*</span>
									</label></th>
									<th><input type="text" id="L_examnum" name="examnum"
										required="" lay-verify="examnum" autocomplete="off"
										class="layui-input" value=""></th>
								
								</tr>
								<tr>
									<th colspan="4" align="center">
										<button class="layui-btn" lay-filter="selects" lay-submit="">搜索</button>
									</th>
								</tr>
							</table>
						</form>
					...
					<div class="layui-card-body layui-table-body layui-table-main">
						...
						<thead>
								...
								<c:forEach items="${records }" var="record">
									<tr>
									<td id="td1"><input type="checkbox" id="inty" class="chooseBox" value="${record.examnum }" ></td> 
										<td>${record.examnum }</td>
...
function delAll () {
    layer.confirm('确认要删除吗？',function(index){
        ...
        for(var i =0 ;i<option.length;i++){
        	$.post('delete', {"examnum":option[i].value}, function(ajaxObj) {
...
//监听提交
form.on('submit(selects)', function(data) {
	$.post("selects",data.field,function(){
